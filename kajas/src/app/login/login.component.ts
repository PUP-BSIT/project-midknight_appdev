...
export class LoginComponent implements OnInit, OnDestroy {
  ...
  onSubmit(): void {
    if (this.loginForm.valid) {
      this.http.post<LoginResponse>('http://api.kajas.site/api/login', this.loginForm.value).subscribe({
  ...
  private handleLoginSuccess(response: LoginResponse): void {
    ...
    this.http.get<LocationResponse>(`http://api.kajas.site/api/location/id?id=${response.user.user_id}`).subscribe({
